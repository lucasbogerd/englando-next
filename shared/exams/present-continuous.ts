...
export const sampleExam: UnparsedExam = {
	...
	exercises: [
		...
		'What {?he try=is he trying} to say? I can’t understand him.',
		...
		'At the moment we {?not watch=aren’t watching} TV because we have lost electricity.',
		...
		'The chef {?not prepare=isn’t preparing} the food now but later.',
		...
		'She {?not write=isn’t writing} her paper right now.',
